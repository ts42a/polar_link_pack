...
\subsection{64-bit Packet Bitfield Layout (MSB$\rightarrow$LSB)}
\begin{figure}[h]
\centering
\begin{lstlisting}
Bit index: 63                                                   0
...
\end{lstlisting}
\caption{Absolute 64-bit PLP packet bitfield layout.}
\end{figure}

\subsection{Delta Frame Application Pipeline}
\begin{figure}[h]
\centering
\begin{lstlisting}
          +------------------+        +-------------------+        +---------------------+
...
\end{lstlisting}
\caption{Applying a delta frame to reconstruct the next absolute state.}
\end{figure}

\subsection{ZigZag Mapping Intuition}
\begin{figure}[h]
\centering
\begin{lstlisting}
...
\end{lstlisting}
\caption{ZigZag mapping turns small negatives into small unsigned integers.}
\end{figure}

\subsection{Varint Continuation Semantics (7 data bits / byte)}
\begin{figure}[h]
\centering
\begin{lstlisting}
...
\end{lstlisting}
\caption{Varint packs integers into 7-bit groups; MSB indicates continuation.}
\end{figure}
